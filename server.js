...
const uri = `mongodb+srv://admin:KEEOJlXde1COHZp8@a4-book-tracker.y9opn.mongodb.net/?retryWrites=true&w=majority&appName=A4-Book-Tracker&tls=true&tlsAllowInvalidCertificates=true`;
...
app.get('/auth/github/callback',
    passport.authenticate('github', { failureRedirect: `${process.env.VITE_REACT_APP_CLIENT_URL}/login` }),
    function(req, res) {
...
app.get("/", ensureAuthenticated, async (req, res) => {
    ...
    res.redirect(`${process.env.VITE_REACT_APP_CLIENT_URL}/`);
})
